...
if (Meteor.isServer) {
  Meteor.startup(function () {
    var board = [
      { text: "Forgets this is a required class", },
      { text: "MIPS", },
      { text: "Interfaces", },
      { text: "Makes an incomprehensible example", },
      { text: "Talking about old technology", },
      { text: "Impressed by newfangled technology", },
      { text: "Business Costs", },
      { text: "Assumes you want to be a computer architect",  },
      { text: "Forgets what class he's teaching", },
      { text: "Shitty Powerpoint Graphics", },
      { text: "Can't read the text on the screen",  },
      { text: "Student falls asleep",  },
      { text: "Someone asks a dumb/irrelevant question",  },
      { text: "Someone gives a completely wrong answer", },
      { text: "Fully paces the front and sides of the room", },
      { text: "Answers his question without waiting", },
      { text: "Acts like he just made a profound statement", },
      { text: "Asks question to class - recieves no answer", },
      { text: "Stares someone down", },
      { text: "Tries to seem cool by forcing a joke", },
      { text: "Look at the contents of the flip flops" },
      { text: "Assumes everyone knows a language that everyone clearly doesn't know" },
      { text: "'This is basically...'" },
      { text: "State Machines" },
      { text: "Billions and billions" },
      { text: "'The interesting part'" },
      { text: "Runs over class time" },
      { text: "Write to memory" },
      { text: "Reuses same shitty graphic in another slide" },
      { text: "Useless example is useless" },
      { text: "You're a lousy programmer" },
      { text: "Student calls out a mistake" },
      { text: "Painfully walks through a circuit" },
      { text: "Says any component more than three times in one sentence." },
      { text: "A word is repeated so much that it no longer sounds like a real word" },
